...
CFLAGS = $(CFLAGS) -I$(SDL_PATH_VC)\include -Dmain=SDL_main
LDFLAGS = $(LDFLAGS) -L$(SDL_PATH_VC)\lib\x64 -lSDL2 -lSDL2main -Xlinker /subsystem:windows

# Add SDL Image compiler/linker flags.
CFLAGS = $(CFLAGS) -I$(SDL_IMAGE_PATH_VC)\include -D_REENTRANT 
LDFLAGS = $(LDFLAGS) -L$(SDL_IMAGE_PATH_VC)\lib\x64 -lSDL2_image
